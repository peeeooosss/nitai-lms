...
export default function SubscribePage() {
  ...
  const handleSelectPlan = (planId: string) => {
    if (!user) return;
    // Once Hercules Commerce is set up, this will redirect to checkout
    // For now show a thank-you message
    navigate(`/products/picto-lab/subscribe?plan=${planId}&status=pending`);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-28 pb-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          >
            <ArrowLeft className="w-4 h-4" /> Back to Picto Lab
          </Link>
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-xl mx-auto">
              Give your students unlimited access to all challenges, projects, and learning tools.
            </p>
          </motion.div>
